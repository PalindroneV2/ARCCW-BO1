...
if SERVER then
    ...
    function ENT:PhysicsCollide(data, physobj)
        ...
        ParticleEffect("rgmk2_impact_glow", self:GetPos(), Angle(0,0,0))
...
function ENT:Draw()
    ...
    cam.Start3D() -- Start the 3D function so we can draw onto the screen.
        ...
        render.DrawSprite( self:GetPos(), math.random(30, 45), math.random(30, 45), Color(50, 255, 100) ) -- Draw the sprite in the middle of the map, at 16x16 in it's original colour with full alpha.
    cam.End3D()
end