...
SWEP.Attachments = {
    ...
    }, --1
    {
        ...
        Bone = "j_bolt",
        Offset = {
            vpos = Vector(10.5, 0, -0.6), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
        },
    }, --2
    {
    ...
    }, --4
    {
        ...
        Bone = "j_bolt",
        Offset = {
            vpos = Vector(-1, -0.65, 0.5), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
        },
    }, --5
}
