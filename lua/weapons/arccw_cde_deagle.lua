...
SWEP.ViewModel = "models/weapons/arccw/c_cde_deagle.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_cde_deagle.mdl"
...
SWEP.ShootSound = "ArcCW_CDE.Eagle_Fire"
...
SWEP.IronSightStruct = {
    Pos = Vector(-2.175, 3, 0.85),
    Ang = Angle(-0.2, -0.28, 0),
    Magnification = 1.1,
...
SWEP.CustomizeAng = Angle(20, 45, 40)
...
SWEP.Attachments = {
    {
        ...
        Bone = "tag_weapon",
        Offset = {
            vpos = Vector(4, 0.35, 1.75),
            vang = Angle(0, 0, 0),
        },
        CorrectivePos = Vector(0, 5, 0),
        CorrectiveAng = Angle(0, -0.275, 0),
    }, --1
    { --2
        PrintName = "Muzzle",
    ...
    { --4
        PrintName = "Tactical",
        Slot = {"tac_pistol", "bo1_tacslot"},
        Bone = "tag_weapon",
        Offset = {
            vpos = Vector(3.5, 0.35, 0.25),
            vang = Angle(0, 0, 0),
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        LHIKOut = 0.2,
        SoundTable = {
            {s = "ArcCW_BO1.CZ75_Out", t = 0.25},
            {s = "ArcCW_BO1.CZ75_In", t = 1}
        },
    },
    ["reload_empty"] = {
        Source = "reload_empty",
