...
sound.Add({
    name = "ArcCW_BO2.Kard_Fire",
    channel = CHAN_WEAPON,
    level = 100,
    sound = "^weapons/arccw/bo2_generic_pistol/fire_kard.wav"
})
sound.Add({
...
sound.Add( {
    ...
    --pitch = {95, 110},
    sound = {
        "^weapons/arccw/bo2_generic_smg/fire_evo3.wav",
    }
} )
sound.Add( {
...
sound.Add( {
    name = "ArcCW_BO2.SMR_Fire",
    channel = CHAN_WEAPON,
    volume = 1.0,
    level = 100,
    --pitch = {95, 110},
    sound = {
        "^weapons/arccw/bo2_generic_ar/fire_smr.wav",
    }
} )
sound.Add( {
...
sound.Add( {
    name = "ArcCW_BO2.OSW_Fire",
    channel = CHAN_STATIC,
    volume = 1.0,
    level = 100,
    --pitch = {95, 110},
    sound = {
        "^weapons/arccw/bo2_generic_ar/fire_osw.wav",
    }
} )
sound.Add( {
